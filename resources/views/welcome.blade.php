...
<head>
  ...
  <title>POSYANDU MEKAR ARUM 18</title>
...
<body>
  ...
  <section id="hero">
      ...
      <div class="row">
        <div class="col-lg-7 pt-5 pt-lg-0 order-2 order-lg-1 d-flex align-items-center">
          <div data-aos="zoom-out">
            <h1><span>Selamat Datang di Website POSYANDU MEKAR ARUM 18!</span></h1>
    ...
    {{--  <section id="team" class="team">
      <div class="container">
        ...
        <div class="section-title" data-aos="fade-up">
          <h2>Organisasi</h2>
          <p>ORGANISASI POSYANDU MEKAR ARUM 18</p>
        </div>
  ...
  <footer id="footer">
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>2021<!--Bootslander--></span></strong>. POSYANDU MEKAR ARUM 18
      </div>
      {{--<div class="credits">
