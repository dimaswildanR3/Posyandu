...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">Tambah Data Anak</li>
    </ol>
</nav>
            ...
            <div class="card shadow p-3 mb-5 bg-white rounded">
                <form action="/balita" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input autocomplete="off" type="text" class="form-control @error('orang_tua_id') is-invalid @enderror" name="orang_tua_id" id="orang_tua_id" value="{{ old('orang_tua_id') }}">
                        @error('orang_tua_id')
                        <div class="invalid-feedback">
                            {{$message}}
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea autocomplete="off" class="form-control @error('alamat') is-invalid @enderror" name="alamat" id="alamat" rows="3">{{ old('alamat') }}</textarea>
                        @error('alamat')
                        <div class="invalid-feedback">
                            {{$message}}
                        </div>
